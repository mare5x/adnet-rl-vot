...
class Tracker:
    ...
    args:
        ...
        params_callback, experiment_name: For running experiments without creating new parameter files.
    """

    def __init__(self, name: str, parameter_name: str, run_id: int = None, display_name: str = None, params_callback=lambda x: x, experiment_name: str = None):
        assert run_id is None or isinstance(run_id, int)

        self.name = name
        self.parameter_name = parameter_name
        self.run_id = run_id
        self.display_name = display_name or experiment_name
        ...
        if self.run_id is None:
            ...
            if experiment_name is None:
                ...
                self.results_dir = '{}/{}/{}/{}_{:03d}'.format(env.results_path, self.name, self.parameter_name, experiment_name, self.run_id)
                self.segmentation_dir = '{}/{}/{}/{}_{:03d}'.format(env.segmentation_path, self.name, self.parameter_name, experiment_name, self.run_id)
    ...
    def run_sequence(self, seq, visualization=None, debug=None, visdom_info=None, multiobj_mode=None, return_tracker=False):
